...
func (c *workerServiceClient) Connect(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[WorkerToControl, ControlToWorker], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &WorkerService_ServiceDesc.Streams[0], WorkerService_Connect_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[WorkerToControl, ControlToWorker]{ClientStream: stream}
	return x, nil
}
...
func _WorkerService_Connect_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(WorkerServiceServer).Connect(&grpc.GenericServerStream[WorkerToControl, ControlToWorker]{ServerStream: stream})
}
...
var WorkerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "arcoloom.worker.v1.WorkerService",
	...
	Metadata: "arcoloom/worker/v1/worker.proto",
}
